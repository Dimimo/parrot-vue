    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation" id="slide-nav">
        <div class="container">
            <div class="navbar-header">
                ...
                <router-link class="navbar-brand" to="/m">Puerto Parrot</router-link>
            </div>
            <div id="slidemenu" class="navbar-toggle-link">
                ...
                <ul class="nav navbar-nav">
                    <li>
                        <router-link to="/m">Home</router-link>
                    </li>
                    <li>
                        <router-link to="/m/articles">Articles</router-link>
                    </li>
                    <li>
                        <router-link to="/m/sites">Businesses</router-link>
                    </li>
