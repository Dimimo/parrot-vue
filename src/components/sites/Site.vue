...
<template>
    <div v-if="site">
        <div v-if="site.picture" class="site-img">
            <img :src="'https://parrot.app/storage/sites/' + site.picture.location" alt="">
        </div>
        <div class="site-info">
            <table class="table">
                <tr>
                    <td class="bigger-200">{{ site.name }}</td>
                </tr>
                <tr>
                    <td class="bigger-140">{{ site.description }}</td>
                </tr>
                <tr>
                    <td><span v-html="site.body"></span></td>
                </tr>
            </table>
            <router-link to="/m/sites">Back to sites</router-link>
        </div>
    </div>
</template>
